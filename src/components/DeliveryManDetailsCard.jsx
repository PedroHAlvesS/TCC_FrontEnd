...
export default function DeliveryManDetailsCard({ deliveryMan, onEdit, onDelete }) {
    ...
    <div className="delivery-man-info-card">
      <div className="delivery-man-card-header">
        ...
        <div className="delivery-man-actions">
          ...
          <button type="button" className="secondary-button delete-button" onClick={onDelete}>
            Excluir Entregador
          </button>
        </div>
      </div>
