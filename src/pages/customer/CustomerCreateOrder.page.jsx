...
export default function CustomerCreateOrderPage() {
	...
	async function handleSubmit(event) {
		...
		if (
			...
			setMessage(
				"Preencha a descrição, informe um CEP válido e o número do endereço.",
			);
			return;
		}
			...
			<main className="login-container">
				<div className="login-card">
					...
					<form onSubmit={handleSubmit} className="login-form">
						...
						{loadingCep ? (
							<div className="info-message">Consultando CEP...</div>
						) : null}
						...
						{message ? (
							<div
								className={
									messageType === "error" ? "error-message" : "success-banner"
								}
							>
								{message}
							</div>
