...
import { fetchCustomers, fetchAdminProfile } from '../services/dashboardService';
      ...
      <div className="dashboard-main">
        <header className="dashboard-header">
          <div>
            ...
            <div className="dashboard-subtitle">Gerencie os clientes cadastrados no sistema.</div>
          </div>
        ...
        <section className="dashboard-orders">
          ...
          <div className="dashboard-filter-row" style={{ gridTemplateColumns: '1fr 240px' }}>
            <label>
